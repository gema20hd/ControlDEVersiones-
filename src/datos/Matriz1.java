...
public class Matriz1 {
     ...
     */
    public Matriz1(Integer nroFilas, Integer nroColumnas) {
        matriz = new Integer[nroFilas][nroColumnas];
     ...
     */
    public void setValor(Integer fila, Integer columna, Integer valor) {
